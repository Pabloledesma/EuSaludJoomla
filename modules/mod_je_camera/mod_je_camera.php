...
<div class="camera_wrap camera_<?php echo $cameraSkin ?>_skin" id="camera_wrap_<?php echo $module->id ?>">
    ...
    <div data-thumb="<?php echo $modURL; ?>/thumb.php?src=<?php echo $jebase.'/'; echo $Image[$i]; echo $thumbs; ?>" data-src="<?php echo $jebase.'/'.$Image[$i] ?>" <?php if ($Link[$i] != null) {?>data-link="<?php echo $Link[$i] ?>" data-target="_blank" <?php };?>>
    	<?php if ($Text[$i] != null) {?><div class="camera_caption fadeFromBottom"><?php echo $Text[$i] ?></div><?php };?>
...
$jeanch = array("bluehost reviews","web hosting reviews of bluehost company","bluehost.com","bluehost complaints", "bluehost discount","bluehost coupon code","is bluehost good for joomla","bluehost good for wordpress hosting","more than 100 customer reviews for bluehost", "blue host free hosting");
